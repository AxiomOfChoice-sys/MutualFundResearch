...
result_format = utils.display_regress_result(model)
...
result_format_BHRG = utils.display_regress_result(model)
model = utils.window_dress_fund_characters_regress(combined_data, WD = 'rank_gap')
result_format_rank_gap = utils.display_regress_result(model)
...
result_format_BHRG = utils.display_regress_result(model_BHRG)
model_rank_gap = utils.corr_window_dressing_regress(funds_monthly_holds_winners_corr, rank_gap.rename('WD'))
result_format_rank_gap = utils.display_regress_result(model_rank_gap)
